...
The app also builds separate baselines for **cardio-only sessions** and **cardio after a workout**. A linked workout is classified as after-workout cardio when it contains at least one strength movement.
